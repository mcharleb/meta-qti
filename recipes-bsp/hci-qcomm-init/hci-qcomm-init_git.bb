...
SRC_URI += "file://0003-Enable-feature-to-read-from-persist-partition.patch"
SRC_URI += "file://0004-btnvtool-print-mac-addr-bytes-in-correct-order.patch"
SRC_URI += "file://0005-Print-leading-0-s-when-display-mac-addr.patch"
